...
async function push(msg) {
  await index();
  for (const p of ['stars', 'shots', 'sky', 'SKY.md', 'logic', 'LOGIC.md', 'soul', 'SOUL.md', 'chemistry', 'CHEMISTRY.md', 'electron', 'ELECTRON.md', 'magnetar', 'MAGNETAR.md', 'vedic', 'VEDIC.md', 'random', 'RANDOM.md', 'voltage', 'VOLTAGE.md', 'elements', 'PERIODIC-TABLE.md']) await git('add', '--', p).catch(() => {});
